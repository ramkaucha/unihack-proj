...
from ..service.post_service import (
    get_posts_s,
    get_posts_sorted_by_popularity_s,
    get_post_s,
    create_post_s,
    update_post_s,
    archive_post_s,
...
def get_posts():
    return jsonify(get_posts_s()), 200


def get_posts_sorted_by_popularity():
    return jsonify(get_posts_sorted_by_popularity_s()), 200


def get_post(post_id):
    return jsonify(get_post_s(post_id)), 200
...
def create_post():
    ...
    return jsonify(create_post_s(data)), 201
