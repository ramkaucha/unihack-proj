...
# update comment
comment_bp.route("/<int:user_id>/<int:comment_id>", methods=["PUT"])(CommentController.update_comment)
# delete comment
comment_bp.route("/<int:user_id>/<int:comment_id>", methods=["DELETE"])(CommentController.delete_comment)